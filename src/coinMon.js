...
var coinMarketCapTable = grid.set(0, 0, 4, 12, contrib.table, {
  keys: true,
...
/*var coinMarketCapLine = grid.set(0, 0, 4, 12, contrib.line, {
  showNthLabel: 5,
  maxY: 100,
  label: 'coinmarketcap.com',
  showLegend: true,
...
function init() {
  new monitor.MarketCoinCap(coinMarketCapLine); //no Windows support
